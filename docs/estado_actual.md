...
Última actualización: 2026-05-18 (Privatización de catálogos `/api/barberos`, `/api/servicios`, `/api/productos`, `/api/categorias` — ahora exigen JWT operativo/admin. La app del barbero migró su selector pre-PIN a `/api/turnero/barberos`).
