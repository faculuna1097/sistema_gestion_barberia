...
// Idéntico al de frontend-turnero — la fuente de verdad vive allá.
...
export const theme = {
  ...
  // Ancho máximo de la columna principal.
  // Nota: en el panel admin (desktop/iPad horizontal) este valor
  // NO se usa como max-width angosto del turnero (480). El shell
  // del admin define su propio ancho en Fase 3.
  maxWidth:  480,
