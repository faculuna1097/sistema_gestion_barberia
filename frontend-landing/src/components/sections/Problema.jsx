...
import { CalendarX2, Wallet, Clock } from 'lucide-react';
...
// Los 3 dolores más fuertes, en voz de queja del dueño. icon = componente
// Lucide. Los otros dolores (papeles/Excel, "no sé si crezco") se cubren más
// abajo en Comparación y en las métricas del panel, para no repetir.
const PROBLEMAS = [
  {
    icon: CalendarX2,
