// /frontend-barbero/src/components/ui/Field.jsx
 ...
 * @param {string} [props.type='text'] - text|email|tel|password|number|date|datetime-local|time
 ...
 * @param {string} [props.min] - Atributo min del input (aplica a date/number/time)
 * @param {string} [props.max] - Atributo max del input (aplica a date/number/time)
 */
function Field({
  label,
  value,
