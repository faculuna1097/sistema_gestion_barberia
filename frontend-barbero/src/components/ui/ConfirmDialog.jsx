// /frontend-barbero/src/components/ui/ConfirmDialog.jsx
// Modal de confirmación. Reemplaza al window.confirm() de GestionTurno.
 ...
 * @param {string|ReactNode} props.message - Texto o JSX del cuerpo (acepta listas, etc.)
